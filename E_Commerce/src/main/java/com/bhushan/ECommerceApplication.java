...
public class ECommerceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		try {
			...
			List<Role> findAll = roleRepo.findAll();
			if (findAll.isEmpty()) {
		...
		boolean existsByEmail = customerRepo.existsByEmail("bhupatil0001@gmail.com");
		...
		if (existsByEmail) {
			...
			admin.setContact("8975891291");
			admin.setEmail("bhupatil0001@gmail.com");
			admin.setFirstName("bhushan");
			admin.setLastName("patil");
			admin.setPassword(passwordEncoder.encode("Bhu@123"));
